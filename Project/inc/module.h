...
#define MIN_EXCHANGE_PERIOD         100 //мс
...
extern void port_set_block_state(uint8_t num, enum ch_state, enum ch_mode);
extern void port_get_block_state(uint8_t num, enum ch_state *, enum ch_mode *);
...
typedef struct {
	...
	volatile uint16_t config_change;	// 1 - сбросить, 2 - сохранить
